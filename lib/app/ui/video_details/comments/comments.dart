...
import 'package:opentrend/app/ui/video_details/comments/comments_reply.dart';
              ...
              child: Obx(
                () {
                  if (commentsController.isLoading.value) {
                    ...
                    if (commentsController.commentList.isNotEmpty) {
                      if (commentsController.commentList[0].data!.isEmpty) {
                        ...
                        return ListView.builder(
                          ...
                          itemCount:
                              commentsController.commentList[0].data?.length,
                          itemBuilder: (context, index) {
                            var discoverData =
                                commentsController.commentList[0].data!;
