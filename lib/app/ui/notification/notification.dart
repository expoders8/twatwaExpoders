      ...
      body: Obx(() {
        if (notificationController.isLoading.value) {
          ...
          if (notificationController.notificationList[0].data != null) {
            if (notificationController.notificationList[0].data!.isEmpty) {
              return Center(
                child: SizedBox(
                  width: Get.width - 80,
                  child: const Text(
              ...
              return ListView.builder(
                ...
                itemCount:
                    notificationController.notificationList[0].data!.length,
                itemBuilder: (context, index) {
                  ...
                  if (discoverData.isNotEmpty) {
                    ...
                    final differenceHour = date2.difference(date1).inHours;
                    final differenceMinute = date2.difference(date1).inMinutes;
                    return Padding(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        data.userProfilePhoto.toString(),
                                        fit: BoxFit.cover,
                                        errorBuilder:
